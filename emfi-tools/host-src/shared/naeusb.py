...
# import ballistic_firmware as fw_ballistic
...
NEWAE_VID = 0x04D8
NEWAE_PIDS = {
    0xe51f: {'name': "EMFI-Target", 'fwver': [2, 0] } # fw_ballistic.fwver jleclair
}
...
class NAEUSB_Backend:
    ...
    def get_possible_devices(self, idProduct=None, dictonly=True):
        """Get list of USB devices that match NewAE vendor ID (0x04d8) and
        ...
        dev_list = [dev for dev in self.usb_ctx.getDeviceIterator() if dev.getVendorID() == 0x04d8]
